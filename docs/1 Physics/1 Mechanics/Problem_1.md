...
1.  **Initial Velocity Components:**
    ...
    A projectile is launched with an initial velocity $v_0$ at an angle $\theta$ to the horizontal.
...
3.  **Horizontal Range:**
    ...
    The horizontal range $R$ is the horizontal distance covered during this time $T$.
